...
$initial_load = elgg_get_plugin_setting('initial_load', 'photosmap');
...
$body_vars = array();
$body_vars['s_action'] = 'photosmap/nearby_search';
...
$sidebar = '';
$layout = 'one_column';
//if (amap_ma_check_if_add_sidebar_list('photosmap')) {
//    $layout = 'content';
//    $sidebar = elgg_view('amap_maps_api/sidebar_elist', array(
//            'mapheight' => $mapheight,
//            'list_view' => 'photosmap/sidebar'
//    ));
//}
